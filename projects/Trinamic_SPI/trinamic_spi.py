...
drvctrl = hal.newsig('drvctrl-signal', hal.HAL_U32)
chopconf = hal.newsig('chopconf-signal', hal.HAL_U32)
smarten = hal.newsig('smarten-signal', hal.HAL_U32)
sgcsconf = hal.newsig('sgcsconf-signal', hal.HAL_U32)
drvconf = hal.newsig('drvconf-signal', hal.HAL_U32)
